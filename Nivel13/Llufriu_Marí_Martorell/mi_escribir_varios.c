/*
 * mi_escribir_varios.c -> muestra todo el contenido de un fichero
 * Miembros: 
 *   - Joan Martorell Coll
 *   - Juan José Marí
 *   - Daniel Llufriu
...
int main(int argc, char **argv){
 ...
 if (argc!=5) {
   fprintf(stderr, ROJO "Sintaxis: mi_escribir_varios <nombre_dispositivo> </ruta_fichero> <texto> <offset>\n" RESET);
   exit(-1);
  }
